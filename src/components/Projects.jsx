          ...
          <div className="grid grid-cols-2 gap-4 mt-5">
            ...
            >
              ...
              >
                ...
                <p className="text-sm sm:text-base">
                  I work with the company Mellow Golem Games as a react
                  developer and creative director. I help the owner (another
                  software developer) with developing applications that assist
                  with the play of table-top RPGs. I am usually tasked with
                  building components, setting up our API handling or doing
                  slight design changes. These are production apps, so I cannot
                  share the code. Stop by our RPG Content section to see my
                  writing as well.
                </p>
