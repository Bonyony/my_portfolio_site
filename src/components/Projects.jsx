    ...
    <>
      ...
      <div className="mx-4 sm:mx-12 lg:mx-24 mt-40 mb-24">
        ...
        <div className="grid grid-cols-2 gap-4 mt-5">
          <div id="projectTotal1" className="font-mono justify-between ">
            ...
            >
              ...
              <p className="text-sm sm:text-base">
                ...
                progress with 3D modeling and development in my career. Although
                it is mobile friendly, I highly reccomend using a laptop or
                desktop to interact with this page!
              </p>
              {/* Grid layout for item 1 */}
          ...
          <div
            id="projectTotal2"
            className="flex flex-row font-mono justify-between "
          >
            <div
              id="projectDetail"
              className={
            ...
            >
              ...
              <p className="text-sm sm:text-base">
                ...
                in. The user can choose from all 12 keys, major or minor scales,
                and the degree of the scale. The application returns the 3 notes
                that make the chord, in both text form and displayed on a
                musical staff (treble cleff only).
              </p>
              {/* Grid layout for item 2 */}
              <div className="grid grid-cols-1  gap-5 mt-2">
                <img
                  src={chordPic}
                  className="rounded-md"
          ...
          >
            ...
            >
              ...
              <p className="text-sm sm:text-base">
                ...
                developer) with developing applications that assist with the
                play of table-top RPGs. I am usually tasked with building
                components, setting up our API handling or doing slight design
                changes. These are production apps, so I cannot share the code.
                Stop by our RPG Content section to see my writing as well.
              </p>
              {/* Grid layout for item 3 */}
              <div className="grid grid-cols-1 gap-5 mt-2 ">
                <img
                  src={mggPic}
                  className="rounded-md "
