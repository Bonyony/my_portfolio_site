  ...
  return (
    <>
      <section id="home" className="  ">
        <img
          className="-z-10 absolute -rotate-12 lg:rotate-0 top-[280px] sm:top-[180px] md:top-[95px] lg:top-[20px] left-[140px] sm:left-[250px] md:left-[300px] lg:left-[500px] xl:left-1/2 xl:rotate-[3deg] transition-all duration-300"
          src={hyrax}
